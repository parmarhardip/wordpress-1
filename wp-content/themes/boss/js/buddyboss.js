        ...
        function contentHeight() {
            ...
            var height = 0,
               ...
               if($('.page-header').outerHeight() > 0 ) {
                    cover_height = $('.page-header').outerHeight();
               }
        ...
        function sidebarHeight() {
            ...
            if(!is_mobile && $primary.length > 0) {
               ...
               var height = 0;
                ...
                if ( !(viewport().width < 900 || (viewport().width < 1000 && $('body').hasClass('left-menu-open'))) && !disable ){
                ...
                if($primary.length > 0 && $secondary.length > 0){
                    if (!(viewport().width < 900 && $('body').hasClass('left-menu-open'))){
                       if($secondary.outerHeight() <= $primary.outerHeight()){
                        ...
                        $secondary.removeStyle('border-left-width');
                        $primary.removeStyle('border-right-width');
                    }
                }
...
//        });
        ...
        function menuToggle(){
            if(is_mobile || ($('body').hasClass('tablet') && $('body').hasClass('left-menu-open') && $('body').hasClass('tablet')) ){ 
                attachArrows();
            }else{
                removeArrows();
            }
        ...
        function initSpinner(){
            $('#main-button, .generic-button:not(.pending)').on( 'click', function(){
                $link  = $(this).find('a');
...
//            $(window).resize(searchWidth); 
        ...
        if(!is_mobile) {
           ...
           $("#nav-menu").find("#menu-main-menu").jRMenuMore(60);  
           $("#header-menu > ul").jRMenuMore(50);
        }
        ...
        function alignMenu(obj) {
            ...
            $(obj).append(
                    '<li  style="position:relative;" href="#" class="hideshow">'+
                        '<a href="#"><i class="fa fa-ellipsis-h"></i></a><ul class="custom-responsive-ul">'+
                     menuhtml + '</ul></li>');
